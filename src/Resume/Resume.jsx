...
//   Star,
//   Zap, // Added for the fun fact icon
// } from "lucide-react";
...
//       <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 py-10 px-4 transition-colors duration-300 print:bg-white print:text-black">
//         <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 shadow-2xl rounded-2xl p-10 print:shadow-none print:p-0">
//           {/* Header utilities */}
...
//           {/* Header */}
//           <header className="flex flex-col md:flex-row md:items-center md:justify-between border-b dark:border-gray-700 pb-6 mb-6 gap-6">
//             <div>
...
//               </div>
//             </div>
//             {/* Avatar: Make sure resphoto.jpg is in your `public` folder */}
//             <img
//             src={resPhoto}
...
//           {/* --- Quick Links --- */}
//           <div className="flex justify-center items-center gap-8 my-6 text-sm font-medium print:hidden">
...
//                   <th className="py-2">Degree/Certificate</th>
...
//                   <td className="py-2">B.E. CSE</td>
//                   <td>AVS Engineering College</td>
//                   <td>8.67</td>
//                   <td>2022‑2026</td>
//                 </tr>
//                 <tr className="border-b dark:border-gray-700">
//                   <td className="py-2">Senior Secondary</td>
//                   <td>St. Mary's Junior College</td>
//                   <td>77.2%</td>
//                   <td>2020‑2022</td>
//                 </tr>
//                 <tr>
//                   <td className="py-2">Secondary</td>
...
//               </tbody>
//               <tr> 
//                <center><td>Completed the all exams in Hindi (A degree Holder in Hindi)</td></center>
//               </tr>
//             </table>
//           </Section>
          
//           {/* A new section using the existing component structure */}
...
//           {/* Footer */}
//           <footer className="text-center text-xs text-gray-500 mt-10 print:hidden">
...
//       <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 border-b-2 border-blue-200 dark:border-blue-700 pb-1 mb-4 print:bg-transparent">
//         {title}
//       </h2>
//       {children}
//     </section>
...
// function Experience({ role, company, period, details }) {
//   return (
//     <div className="mb-6">
//       <h3 className="font-bold text-lg text-gray-900 dark:text-gray-100">
//         {role}, <span className="font-medium text-gray-800 dark:text-gray-200">{company}</span>
//       </h3>
