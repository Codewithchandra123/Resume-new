    ...
    <div className={`${dark ? "dark" : ""}`}>
      <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 py-8 px-4 transition-colors duration-300 print:bg-white print:text-black leading-tight">
        <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 shadow-2xl rounded-2xl p-6 print:p-4 print:shadow-none">
          ...
          {/* Header */}
          <header className="flex flex-col md:flex-row md:items-start md:justify-between border-b dark:border-gray-700 pb-3 mb-3 gap-3">
            <div>
              ...
              <div className="mt-2 space-y-0.5 text-xs">
                <ContactLine
                  icon={Mail}
                  text="tejakancharla77@gmail.com"
          ...
          <Section title="About Me">
            <p className="text-sm">
              I'm a passionate and results-driven Full-Stack & Java, Python
              Developer with a strong desire to build dynamic, responsive, and
              scalable web applications. I thrive on solving problems, writing
              clean code, and building products that create meaningful user
              experiences. With a strong foundation in both frontend and backend
              development, I believe in continuous learning and collaboration as
              key ingredients to creating great software and also Completed more
              than 400 Labs on <strong>Google cloud skill boost</strong> and
              reached the <strong>Arcade Legend Tier.</strong>
            </p>
          </Section>
          ...
          <Section title="Tech Stack & Tools">
            <SkillGrid
              skills={{
                ...
                "CS Fundamentals":
                  "Data Structures & Algorithms, REST APIs, OOP. (Basic)",
              }}
            />
          </Section>
          ...
          <Section title="Professional Goal">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              I am actively seeking full-time Full-Stack or Java Developer roles
              (Remote or On-site) where I can contribute to impactful projects,
              grow alongside experienced professionals, and help shape modern
              digital solutions. I am also open to freelance and collaborative
              open-source projects and ready to join a team where innovation,
              mentorship, and creativity thrive.
            </p>
          </Section>
              ...
              <table className="w-full min-w-[32rem] text-left text-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    <td
                      colSpan="4"
                      className="pt-2 text-center text-xs text-gray-600 dark:text-gray-400"
                    >
          ...
          <Section title="Internships">
            <ul className="list-disc ml-5 space-y-0.5 text-sm">
              <li>
                Completed a Web Development internship at
                <strong> Apex Planet Pvt Ltd</strong> (Online), where I improved
                my frontend skills.
              </li>
              <li>
                Learned Python concepts through an online internship with
                <strong> SoloLearn</strong>, gaining a solid foundation in
                programming.
              </li>
              <li>
                Worked on-site at <strong>Odugaa Tech Pvt Ltd</strong>, building
                real-time web features and gaining hands-on development
                experience.
              </li>
            </ul>
          </Section>
          ...
          <Section title="Achievements">
            <ul className="list-disc ml-5 space-y-0.5 text-sm">
              <li>
                Led my team to victory at Hackxelerate '25 in KPR Engineering
                College with our innovative project <strong>Vouchify</strong>.
              </li>
              <li>
                Participated in <strong>CodeVolt '25</strong> at VIT Chennai —
                although we didn’t win, the experience fueled my determination.
              </li>
              <li>
                That loss motivated me to form a new team for KPR Hackathon,
                where I led from the front, found a strong idea, and won.
              </li>
              <li>
                I believe setbacks are setups for comebacks — I push myself
                harder after every challenge to achieve what I once missed.
              </li>
            </ul>
          </Section>
  ...
  if (href) {
    return (
      <a
        ...
        target={target}
        rel="noopener noreferrer"
        className="hover:underline text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 block transition-colors"
      >
        {Content}
      </a>
    );
    ...
    <div className="grid md:grid-cols-2 gap-x-6 gap-y-1.5 text-sm">
      {Object.entries(skills).map(([category, stack]) => (
        <div key={category} className="flex gap-1.5 items-start">
          <Star
            size={14}
            className="shrink-0 mt-0.5 text-blue-700 dark:text-blue-400"
          />
          <div>
