...
//             <ul className="list-disc ml-6 space-y-1 overflow-visible">
...
//               <LanguagesIcon size={16} className="text-blue-700 dark:text-blue-400" /> English
//             </li>
//             <li className="flex items-center gap-1">
//               <LanguagesIcon size={16} className="text-blue-700 dark:text-blue-400" /> Telugu (Native)
//             </li>
//             <li className="flex items-center gap-1">
//               <LanguagesIcon size={16} className="text-blue-700 dark:text-blue-400" /> Tamil
//             </li>
//             <li className="flex items-center gap-1">
//               <LanguagesIcon size={16} className="text-blue-700 dark:text-blue-400" /> Hindi
//             </li>
//           </ul>
//         </Section>
